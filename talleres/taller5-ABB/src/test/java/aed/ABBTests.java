...
class ABBTests {
    ...
    @Test
    void eliminar_elemento_con_un_descendiente2() {
        ABB<Integer> conjunto = new ABB<Integer>();
    ...
    @Test
    void eliminar_elemento_con_dos_descendientes2() {
        ABB<Integer> conjunto = new ABB<Integer>();
    ...
    @Test
    void eliminar_elemento_con_doble_descendencia2() {
        ABB<Integer> conjunto = new ABB<Integer>();
    ...
    @Test
    void eliminar_elemento_con_sucesor_arriba2() {
        ABB<Integer> conjunto = new ABB<Integer>();
    ...
    Integer NCLAVES2 = 1000; 

    private Integer clave2(Integer i) {        
        return NCLAVES * ((i * i - 100 * i) % NCLAVES) + i;
    }
